                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form action="{{ route('jobs.update', $job->id) }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="job_title" id="job_title" value="{{ $job->job_title }}" class="mt-1 p-2 border rounded-md w-full" placeholder="Job title" required>
                        </div>
                        <div class="mb-4">
                            ...
                            <input type="text" name="post_number" id="post_number" value="{{ $job->post_number }}" class="mt-1 p-2 border rounded-md w-full" placeholder="Post number" required>
                        </div>
                        <div class="mb-4">
                            ...
                            <input type="text" name="cost_code" id="cost_code" value="{{ $job->cost_code }}" class="mt-1 p-2 border rounded-md w-full" placeholder="Cost code" required>
                        </div>
                        <div class="mb-4">
                            ...
                            <input type="text" name="pay_rate" id="pay_rate" value="{{ $job->pay_rate }}" class="mt-1 p-2 border rounded-md w-full" placeholder="Pay rate" required>
                        </div>
                        <div>
