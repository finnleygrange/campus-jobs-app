                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form action="{{ route('managers.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="email" name="manager_email" id="manager_email" class="mt-1 p-2 border rounded-md w-full bg-gray-700 text-white" placeholder="Email address" required>
                        </div>
                        <div>
