                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form action="{{ route('students.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="student_number" id="student_number" class="mt-1 p-2 border rounded-md w-full text-black" placeholder="Student number" required>
                        </div>
                        <div class="mb-4">
                            ...
                            <input type="text" name="student_first_name" id="student_first_name" class="mt-1 p-2 border rounded-md w-full text-black" placeholder="First name" required>
                        </div>
                        <div class="mb-4">
                            ...
                            <input type="text" name="student_last_name" id="student_last_name" class="mt-1 p-2 border rounded-md w-full text-black" placeholder="Last Name" required>
                        </div>
                        <div class="mb-4">
                            ...
                            <input type="email" name="student_email_address" id="student_email_address" class="mt-1 p-2 border rounded-md w-full text-black" placeholder="Email address" required>
                        </div>
                        <div class="mb-4">
                            ...
                            <input type="date" name="visa_end_date" id="visa_end_date" class="mt-1 p-2 border rounded-md w-full text-black" required>
                        </div>
